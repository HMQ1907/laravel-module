    ...
    <table class="w-full text-sm leading-normal">
        <caption class="text-lg font-semibold text-gray-700 p-4">
            ...
            <p class="text-sm text-gray-600">
                The table below lists all the nicknames and email addresses of the users along with available actions.
            </p>
        </caption>
        <thead>
            <tr>
            ...
            @foreach ($users as $user)
                <tr>
                    <td class="px-2 py-2 border-b border-gray-200 bg-white text-sm">
                        <p class="text-gray-900 whitespace-no-wrap pl-10"> {{ $user->name }}</p>
                    </td>
                    <td class="px-2 py-2 border-b border-gray-200 bg-white text-sm">
                        <p class="text-gray-900 whitespace-no-wrap pl-10">{{ $user->email }}</p>
                    </td>
                    <td class="px-2 py-2 border-b border-gray-200 bg-white text-sm">
                        <div class="flex flex-wrap pl-10">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-8 cursor-pointer">
